...
import com.hh.sdk.util.ConfigurationTools;
...
//	zz$r0oiljy
	...
	//请CP替换成在斯凯申请的商户密钥
	private String MerchantPasswd = "5234657658345432543623517248";
	 ...
	 * 则可以将注解A，注解B，注解C，取消注解，然后填写相关参数即可
	 */
	public void startPay(String payPoint, String payPrice, boolean useAppUi,PayListener listener) {
		 ...
		 * 注解A
		 * 如果配置服务端，由取消下面注解
		 * notifyAddress设置CP的回调地址
		 * reserved1 reserved2 reserved3 扩展字段，会随地址一起同步到CP的服务端
		 * 以http get的方式同步给CP端，具体回调参数看文档
		 */
		/*
